...
### Porównaj model z modelem bazowym

Twoim celem na tym etapie jest osiągnięcie mocy statystycznej: to znaczy opracowanie małego modelu, który jest w stanie pokonać model bazowy.
...
Zauważ, że nie zawsze jest możliwe osiągnięcie takiej mocy statystycznej.
