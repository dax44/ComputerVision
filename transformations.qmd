...
Obroty o inne kąty niż pełne wielokrotności 90$\degree$ powodują pewne problemy, ponieważ po rotacji powstają piksele, które nie pokrywają żadnej wartości z oryginalnego obrazu, a część z nich zawiera kilka wartości (patrz -@fig-rotation1).
