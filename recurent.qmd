...
::: {#exm-1}
Najpierw ze strony [ai.stanford.edu/\~amaas/data/sentiment](ai.stanford.edu/~amaas/data/sentiment) pobierzemy surowy zbiór danych IMDB[^1].
Rozkompresuj go.
...
Na przykład, używając kodowania binarnego (multi-hot[^2]), zakodowałbyś tekst jako wektor o tylu wymiarach, ile jest słów w twoim słowniku, z 0 prawie wszędzie i kilkoma 1 dla wymiarów, które kodują słowa obecne w tekście.
...
[^1]: jeśli adres URL już nie działa, wygoogluj "IMDB dataset"

[^2]: kodowanie *multi-hot* jest kodowaniem potrzebującym nieco mniejszych wektorów do zakodowania słów, np.
...
![Przykład osadzenia słów](https://editor.analyticsvidhya.com/uploads/450121_sAJdxEsDjsPMioHyzlN3_A.png){#fig-embd2 fig-align="center" width="600"}
