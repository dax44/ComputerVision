...
Aby pokazać pełny zakres wartości widma, w szczególności mniejsze wartości dla wysokich częstotliwości, często wyświetla się $\sqrt{|G(m,n)|}$ lub $\log|G((m,n)|$ odpowiednio.
...
Najniższa efektywna częstotliwość próbkowania występuje w kierunkach osi współrzędnych siatki próbkującej.
...
![Porównanie kątów w obrazie i widmie](images/Zrzut ekranu 2023-06-15 o 20.59.50.png){#fig-angles fig-align="center" width="500"}

O ile obraz nie jest kwadratowy ($M = N$)[^fourier-2], to kąty orientacji w obrazie i w widmie nie są takie same, choć pokrywają się z kierunkami wzlgędem osi współrzędnych.
...
Obrazy przedmiotów pochodzenia ludzkiego często wykazują regularne wzory lub wydłużone struktury, które dominują w widmie.
